...
_MLA_BACKEND_ALIASES: dict[str, tuple[str, int]] = {
    "FLASH_ATTN_MLA_FA3": ("FLASH_ATTN_MLA", 3),
    "FLASH_ATTN_MLA_FA4": ("FLASH_ATTN_MLA", 4),
    "FLASH_ATTN_MLA_ALL_FA3": ("FLASH_ATTN_MLA", 3),
    "FLASH_ATTN_MLA_ALL_FA4": ("FLASH_ATTN_MLA", 4),
}

_MLA_ALL_PHASE_BACKEND_ALIASES = {
    "FLASH_ATTN_MLA_ALL_FA3",
    "FLASH_ATTN_MLA_ALL_FA4",
}
...
def is_mla_all_phase_backend(backend: str) -> bool:
    """Whether an MLA benchmark alias pins both decode and prefill FA versions."""
    return backend in _MLA_ALL_PHASE_BACKEND_ALIASES
